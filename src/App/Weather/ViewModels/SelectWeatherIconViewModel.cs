...
public partial class SelectWeatherIconViewModel : ViewModelBase
{
    ...
    {
        var weatherIconDescriptionRepository =
            Services.GetRequiredService<WeatherIconDescriptionRepository>();

        var weatherIconList = await weatherIconDescriptionRepository.GetList();
